...
def main():
    ...
    parser.add_argument('--raw_targets_prefix', type=str, default="../data/therapeutic_target_task/raw_targets_")
    args = parser.parse_args()

    therapeutic_areas = args.disease.split(",")
    print(therapeutic_areas)
    subtype_protein_dict = load_PPI_data(args.celltype_ppi)
    celltype2compartment, compartments = read_tissue_metadata("../data/single_cell/ts_data_tissue.csv", "cell_ontology_class")
